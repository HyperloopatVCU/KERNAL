...
void disconnect(socker*);
void closesocket(socker*);
uint8_t opensocket(socker*);
uint8_t connect_block(socker*, quad*, uint16_t);
uint8_t listen_block(socker*);

uint16_t putline(socker*, uint8_t*, uint16_t);
uint16_t getline(socker*, uint8_t*, uint16_t);

void net_config_default(socker*s);
